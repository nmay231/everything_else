...
from Utilies import clear_grid, for_each, restock_empty_tanks, stock_to, to_pos  # noqa: F401
...
# -------------------------------------------------------------------------------
def move(direction: Literal[North, East, South, West]) -> bool:
    """
...
# -------------------------------------------------------------------------------
def swap(direction: Literal[North, East, South, West]) -> bool:
    """
